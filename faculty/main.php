...
if (isset($_POST['sub_user'])) {
  ...
  $sql = 'INSERT INTO faculty_complaints (username, phoneno, email, block, floor, room, complaint_type, issue, importance, complaint_date, description) VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)';
  $stmt = $conn->prepare($sql);
  $stmt->bind_param('sssssssssss', $username, $phoneNo, $email, $blockName, $floor, $roomNo, $complaintType, $issue, $importance, $complaintDate, $description);
...
<body>
	...
	<form method="post" action="main.php" onsubmit="return validateForm()">
		...
		<div class="input-group">
    		...
    		<select id="block_name" name="block">
