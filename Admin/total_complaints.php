...
$query = " 
SELECT aa.Student_Id AS Student_Id, aa.roomno, aa.block_name, aa.floor, aa.complaint_type, aa.description, aa.importance, aa.complaint_date, bb.staffname
FROM backup_complaints AS aa 
...
<div class="ts-main-content">
  <div class="content-wrapper">
    <div class="container-fluid">
      <div class="row">
        <div class="col-md-12">
          <h2 class="page-title">Total Complaints Details</h2>
