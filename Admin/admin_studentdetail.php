...
$query = "
    SELECT aa.Student_Id AS Student_Id, aa.roomno, aa.phoneno, aa.complaint_date ,aa.slot, aa.complaint_type, aa.description, aa.importance, bb.staffname
              ...
              <table id="zctb" class="display table table-striped table-bordered table-hover" cellspacing="0" width="100%">
                ...
                <tbody>
                  ...
                  while($row = mysqli_fetch_array($result)) {
                    ...
                    echo "<td><a href='delete.php?id=".$row['Student_Id']."' onClick=\"javascript:return confirm('Are you sure you want to delete this?');\"><button id='del' >Delete</button></a></td>";
                    echo '</tr>';
                  }
                  ?>
                </tbody>
